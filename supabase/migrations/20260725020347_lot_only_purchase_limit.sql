-- Substitui o limite de compra "por usuário no evento" por um limite
-- exclusivamente por lote: cada lote define seu próprio máximo de
-- ingressos por usuário (histórico de compras naquele lote + o pedido
-- atual), e o limite do evento (Events.MaximoPorUsuario) deixa de ser
-- verificado.
